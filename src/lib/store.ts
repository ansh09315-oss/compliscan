    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        inspectionHistory: (state.inspectionHistory || []).slice(0, 15).map((d) => ({
          ...
          inspectionTimestamp: d.inspectionTimestamp,
          criticalViolations: d.criticalViolations,
          majorViolations: d.majorViolations,
          minorViolations: d.minorViolations,
          mandatoryCount: d.mandatoryCount,
