...
export default function Screen07ExtractedReview() {
  ...
  const [manualFields, setManualFields] = useState({
    ...
    netQuantity: activeDossier?.declaredNetQuantity ? String(activeDossier.declaredNetQuantity) : '',
    netUnit: activeDossier?.declaredNetUnit || 'g',
    mrp: activeDossier?.declaredMrp ? String(activeDossier.declaredMrp) : '',
    uspValue: activeDossier?.declaredUspValue ? String(activeDossier.declaredUspValue) : '',
    mfgMonth: activeDossier?.declaredMfgMonth ? String(activeDossier.declaredMfgMonth) : '',
    mfgYear: activeDossier?.declaredMfgYear ? String(activeDossier.declaredMfgYear) : '',
    manufacturerName: activeDossier?.manufacturerName || '',
    manufacturerAddress: activeDossier?.manufacturerAddress || '',
    fssaiLicenseNo: activeDossier?.comprehensiveDetails?.manufacturerDetails?.fssaiLicenseNo || '',
    ...
    containerHeight: activeDossier?.containerHeightMm ? String(activeDossier.containerHeightMm) : '',
    containerWidth: activeDossier?.containerWidthMm ? String(activeDossier.containerWidthMm) : '',
    fontHeight: activeDossier?.detectedFontHeightMm ? String(activeDossier.detectedFontHeightMm) : '',
